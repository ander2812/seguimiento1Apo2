...
public class Main {
	...
	public void menu() {
		...
		System.out.println(
		 ...
		 final int option = Integer.parseInt(scan.nextLine());
		...
		switch (option) {
			...
			case 1:
				...
				final String typeDocument = scan.nextLine();
				System.out.println(" ");
				System.out.println("por favor ingrese el numero de documento");
				final String docNumber = scan.nextLine();

				try {
					miniMarket.addClient(typeDocument, docNumber);
					
					} catch (final DocNumberException | TypeDocumentException e) {
